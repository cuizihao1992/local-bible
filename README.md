...
```text
dist\android\local-bible-reader-offline-1.9.20-release.apk
```
...
当前是 `V1.9.20` Android 轻量 APK + 按需资源包版。版本计划见 [ROADMAP.md](./ROADMAP.md)，优化体检见 [OPTIMIZATION.md](./OPTIMIZATION.md)。
